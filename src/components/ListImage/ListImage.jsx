...
//       <h2 className="text-lg font-bold mb-3 text-center">Gestionar Carrusel</h2>
...
//             <h3 className="font-semibold text-gray-700">Carrusel {item.id}</h3>
//             <div className="grid grid-cols-3 gap-4 mt-2">
//               {item.images.map((image, index) => (
//                 <div key={index} className="relative">
//                   <img src={image} alt={`Carrusel ${index}`} className="w-full h-24 object-cover rounded-md border" />
//                   <input
//                     type="file"
//                     accept="image/*"
